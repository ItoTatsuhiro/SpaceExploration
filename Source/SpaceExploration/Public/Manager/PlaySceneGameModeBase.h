...
public:
	...
	// --------------------------------------------------------------------------------------------
	UFUNCTION(BlueprintCallable)
	void SetEnemyManager(AEnemyManager* EnemyManager);

	// --------------------------------------------------------------------------------------------
	// 敵の生成、ステータスを管理するアクタークラスの参照を返す
	// --------------------------------------------------------------------------------------------
	UFUNCTION(BlueprintCallable)
	AEnemyManager* GetEnemyManager()
	{
		return EnemyManagerRef;
	}
...
private:
	...
	// ステージデータを管理するアクタークラスの参照
	UPROPERTY()
	AStageDataManager* StageDataManagerRef;
